...
from .serializers import UserRegistrationSerializer, UserConfirmationSerializer, UserProfileSerializer
...
class UserRegistration(viewsets.ViewSet):
    ...
    def signup(self, request):
        ...
        if not serializer.is_valid() or serializer.validated_data['username'] == 'me':
        ...
        ConfCode.objects.create(username = user, confirmation_code = confirmation_code)
...
class UserConfirmation(viewsets.ViewSet):
    ...
    def confirmation(self, request):
        ...
        user_base = get_object_or_404(User, username = serializer.data.get('username'))
